        ...
        <Card className="shadow-lg border-0">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {errors.password && (
                <Alert variant="destructive">
                  <AlertDescription>{errors.password.join(', ')}</AlertDescription>
                </Alert>
              )}
              ...
              <NavLink to={PUBLIC_ROUTES.FORGOT_PASSWORD} className="text-sm text-enterprise-primary hover:underline mt-2 block text-center">
